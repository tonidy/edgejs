...
void UnodeInstallUtilBinding(napi_env env) {
  ...
  static const char kInstallUtilHelpers[] =
      ...
      "  const kProxyDetails = globalThis.__unode_proxy_details || (globalThis.__unode_proxy_details = new WeakMap());"
      "  const kProxyTag = globalThis.__unode_proxy_tag || (globalThis.__unode_proxy_tag = Symbol('unode.proxy.tag'));"
      "  const kExternalStreamTag = globalThis.__unode_external_stream_tag || (globalThis.__unode_external_stream_tag = Symbol('unode.external.stream'));"
      ...
      "    globalThis.__unode_types = typesBinding;"
      "  }"
